...
play_sound( SE_BAKU_S );
	...
	i =  _DIV( elapse, BAKU_FRAME ); if( (i >= 0) && (i < 5) ) drawScaledImage( main_img[RES_IMAGE_BAKU], x + i * 2, y + i * 2, 24 - i * 4, 24 - i * 4, 0, 0, 24, 24 );
	if( w > 26 ){
		if( i == 0 ) quake = 15;
		i = _DIV( elapse - BAKU_LAG1, BAKU_FRAME ); if( (i >= 0) && (i < 5) ) drawScaledImage( main_img[RES_IMAGE_BAKU], x - 6 + i * 2, y - 6 + i * 2, 24 - i * 4, 24 - i * 4, 0, 0, 24, 24 );
		i = _DIV( elapse - BAKU_LAG2, BAKU_FRAME ); if( (i >= 0) && (i < 5) ) drawScaledImage( main_img[RES_IMAGE_BAKU], x + 6 + i * 2, y - 2 + i * 2, 24 - i * 4, 24 - i * 4, 0, 0, 24, 24 );
		i = _DIV( elapse - BAKU_LAG3, BAKU_FRAME ); if( (i >= 0) && (i < 5) ) drawScaledImage( main_img[RES_IMAGE_BAKU], x + 2 + i * 2, y + 6 + i * 2, 24 - i * 4, 24 - i * 4, 0, 0, 24, 24 );
	}
}
