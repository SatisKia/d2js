...
function paint( g ){
 ...
 switch( code ){
 case 0 : codeString = "(ERROR)" ; break;
 case 1 : codeString = "(PERMISSION_DENIED)" ; break;
 case 2: codeString = "(POSITION_UNAVAILABLE)"; break;
 case 3 : codeString = "(TIMEOUT)" ; break;
 case 4 : codeString = "(SUCCESS)" ; break;
 }
